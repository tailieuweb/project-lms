...
if (is_siteadmin()) {
    ...
    ////////////
    // Su mang Title.
    $name = 'theme_eguru/sumangtitle';
    $title = get_string('marketingspot', 'theme_eguru').' 1 - '.get_string('title', 'theme_eguru');
    $description = get_string('sumangtitledesc', 'theme_eguru');
    $default = 'lang:sumangtitledefault';
    $setting = new admin_setting_configtext($name, $title, $description, $default);
    $temp->add($setting);
    // Su mang Description.
    $name = 'theme_eguru/sumangdesc';
    $title = get_string('marketingspot', 'theme_eguru').' 1 - '.get_string('description');
    $description = get_string('mspotdescdesc', 'theme_eguru');
    $default = 'lang:sumangdescdefault';
    $setting = new admin_setting_configtextarea($name, $title, $description, $default, PARAM_TEXT);
    $temp->add($setting);
    /* Su mang*/
    ...
    // Tam nhin Title.
    $name = 'theme_eguru/tamnhintitle';
    $title = get_string('marketingspot', 'theme_eguru').' 1 - '.get_string('title', 'theme_eguru');
    $description = get_string('tamnhintitledesc', 'theme_eguru');
    $default = 'lang:tamnhintitledefault';
    $setting = new admin_setting_configtext($name, $title, $description, $default);
    $temp->add($setting);
    // Tam nhin Description.
    $name = 'theme_eguru/tamnhindesc';
    $title = get_string('marketingspot', 'theme_eguru').' 1 - '.get_string('description');
    $description = get_string('mspotdescdesc', 'theme_eguru');
    $default = 'lang:tamnhindescdefault';
    $setting = new admin_setting_configtextarea($name, $title, $description, $default, PARAM_TEXT);
    $temp->add($setting);
    /** Tam nhin */
    
    // Gia tri Title.
    $name = 'theme_eguru/giatrititle';
    $title = get_string('marketingspot', 'theme_eguru').' 1 - '.get_string('title', 'theme_eguru');
    $description = get_string('giatrititledesc', 'theme_eguru');
    $default = 'lang:giatrititledefault';
    $setting = new admin_setting_configtext($name, $title, $description, $default);
    $temp->add($setting);
    
    $name = 'theme_eguru/giatridesc';
    $title = get_string('marketingspot', 'theme_eguru').' 1 - '.get_string('description');
    $description = get_string('mspotdescdesc', 'theme_eguru');
    $default = 'lang:giatridescdefault';
    $setting = new admin_setting_configtextarea($name, $title, $description, $default, PARAM_TEXT);
    $temp->add($setting);
