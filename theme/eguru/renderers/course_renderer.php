...
class theme_eguru_core_course_renderer extends core_course_renderer {
    ...
    public function frontpage() {
        ...
        foreach (explode(',', $frontpagelayout) as $v) {
            switch ($v) {
                ...
                case FRONTPAGECOURSECUSTOMIZE:
                    $output .= $this->frontpage_part('skipcourses', 'frontpage-category-combo',
                        get_string('courses'), $this->frontpage_list_customize());
                    break;
     ...
     * My custom
     * @author Kang <foostart.com@gmail.com>
     * @return string
     */
    public function frontpage_list_customize() {
        global $CFG;
        ...
        return $this->coursecat_tree_customize($chelper, $tree, true);
    }
     ...
     * @return string
     */
    protected function coursecat_category_customize(coursecat_helper $chelper, $coursecat, $depth) {
        // open category tag
        ...
        if ($chelper->get_subcat_depth() > 0 && $depth >= $chelper->get_subcat_depth()) {
            ...
            $categorycontent = $this->coursecat_category_content_customize($chelper, $coursecat, $depth);
            $classes[] = 'loaded';
        ...
        if (empty($coursecat->get_parents())) {
            $content .= html_writer::start_tag('div', array('class' => 'info'));
        ...
        if (empty($coursecat->get_parents())) {
            ...
            $content .= html_writer::end_tag('div'); // .category
             ...
             $content .= html_writer::tag('div', @$categorycontent, array('class' => ''));
     ...
     * @return string
     */
    protected function coursecat_subcategories_customize(coursecat_helper $chelper, $coursecat, $depth) {
        global $CFG;
        $subcategories = array();
        ...
        foreach ($subcategories as $subcategory) {
            $content .= $this->coursecat_category_customize($chelper, $subcategory, $depth + 1);
        }
     ...
     * @return string
     */
    protected function coursecat_category_content_customize(coursecat_helper $chelper, $coursecat, $depth) {
        $content = '';
        // Subcategories
        $content .= $this->coursecat_subcategories_customize($chelper, $coursecat, $depth);
     ...
     * @return string
     */
    protected function coursecat_tree_customize(coursecat_helper $chelper, $coursecat) {
        // Reset the category expanded flag for this course category tree first.
        $this->categoryexpandedonload = false;
        $categorycontent = $this->coursecat_category_content_customize($chelper, $coursecat, 0);
