...
class __Mustache_23ff7b97e6b4150110e06aaa86a5ecd3 extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        if ($parent = $this->mustache->loadPartial('core_form/element-template')) {
            $context->pushBlockContext(array(
                'element' => array($this, 'block0d690c5240b8bc4a85b0113c9f563107'),
            ));
...
';
    ...
    public function block0d690c5240b8bc4a85b0113c9f563107($context)
    {
        $indent = $buffer = '';
