...
class __Mustache_9006e6a7dd30ad76a22fe9af1422f606 extends Mustache_Template
{
...
';
        ...
        if ($parent = $this->mustache->loadPartial('core_message/message_drawer_lazy_load_list')) {
            $context->pushBlockContext(array(
                ...
                'rootattributes' => array($this, 'blockEb0b3ebbb2a33e66539537fb69e91f34'),
            ));
...
';
    ...
    public function blockEb0b3ebbb2a33e66539537fb69e91f34($context)
    {
        $indent = $buffer = '';
        $buffer .= '            id="';
        $blockFunction = $context->findInBlock('region');
