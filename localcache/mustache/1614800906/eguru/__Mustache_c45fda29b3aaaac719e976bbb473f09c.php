...
class __Mustache_c45fda29b3aaaac719e976bbb473f09c extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        if ($parent = $this->mustache->loadPartial('core_form/element-template-inline')) {
            $context->pushBlockContext(array(
                'element' => array($this, 'block747f85c2bae272712d170a5d7cf0c387'),
            ));
...
';
    ...
    public function block747f85c2bae272712d170a5d7cf0c387($context)
    {
        $indent = $buffer = '';
