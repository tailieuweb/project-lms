...
class __Mustache_c0cdcbc777a28b7085d47a1ba19d5e2b extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $indent . '<div class="border-bottom  p-1 px-sm-2 py-sm-3" aria-hidden="false" ';
