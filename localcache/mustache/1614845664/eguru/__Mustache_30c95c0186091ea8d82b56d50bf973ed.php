...
class __Mustache_30c95c0186091ea8d82b56d50bf973ed extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        if ($parent = $this->mustache->loadPartial('core/drawer')) {
            $context->pushBlockContext(array(
                'drawercontent' => array($this, 'blockA540dafb904fab48fb61320431fb8214'),
            ));
...
';
    ...
    public function blockA540dafb904fab48fb61320431fb8214($context)
    {
        $indent = $buffer = '';
