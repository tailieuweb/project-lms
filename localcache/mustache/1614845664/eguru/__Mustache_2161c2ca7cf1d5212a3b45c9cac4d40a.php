...
class __Mustache_2161c2ca7cf1d5212a3b45c9cac4d40a extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        if ($parent = $this->mustache->loadPartial('core_form/element-template')) {
            $context->pushBlockContext(array(
                'label' => array($this, 'blockFc6123632dcafeb4a49e505438e61707'),
                'element' => array($this, 'blockF8687fe41dfead48f1792fc45e24fbd9'),
            ));
...
';
    ...
    public function blockFc6123632dcafeb4a49e505438e61707($context)
    {
        $indent = $buffer = '';
...
';
    ...
    public function blockF8687fe41dfead48f1792fc45e24fbd9($context)
    {
        $indent = $buffer = '';
