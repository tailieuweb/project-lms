...
class __Mustache_0c3265416b3355079183e2228ef07638 extends Mustache_Template
{
...
';
        ...
        $buffer .= $this->sectionC4ed5f64d0bb11394d6775b3a874242d($context, $indent, $value);
        $buffer .= '
';
        $buffer .= $indent . '    </div>
';
...
';
    ...
    private function sectionEbe801cfe6a7d0b19d6b8ed3b8dc4e23(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
';
    ...
    private function sectionC4ed5f64d0bb11394d6775b3a874242d(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
';
                    ...
                    $value = $context->findDot('element.staticlabel');
                    $buffer .= $this->sectionEbe801cfe6a7d0b19d6b8ed3b8dc4e23($context, $indent, $value);
                    $buffer .= $indent . '        ';
                }
                $context->pop();
            }
