...
/**
 * Strings for component 'chat', language 'vi', version '3.8'.
 *
 * @package     chat
 * @category    string
...
$string['messageenter'] = '{$a} vừa vào phòng chát';
$string['messageexit'] = '{$a} vừa ra khỏi phòng chát này';
$string['messages'] = 'Tin nhắn';
$string['method'] = 'Kiểu chát';
$string['methoddaemon'] = 'Máy chủ chát daemon';
$string['methodnormal'] = 'Kiểu bình thường';
$string['modulename'] = 'Phòng chát';
$string['modulenameplural'] = 'Các phòng chát';
...
$string['notallowenter'] = 'Bạn không có quyền vào phòng chát';
